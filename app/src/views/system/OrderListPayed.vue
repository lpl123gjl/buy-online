<template>
    <div class="wrapper">
          ...
          <ul class="list">
              <li v-for="(item,index) in ordersArray" :key="index" id="kkk" v-if="item.state==1">
                  <div class="headline">
  ...
  export default {
    ...
    methods: {
      ...
      loadOrderListByAccountId(){
        ...
        //   let url = "/OrdersHandler/listByState?accountId="+this.account.accountId
